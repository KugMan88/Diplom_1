...
class TestIngredient:
    def test_ingredient_get_name(self):
        ingredient = Ingredient(ingredient_types.INGREDIENT_TYPE_SAUCE, 'Соус Чили', 3000)
        assert ingredient.get_name() == 'Соус Чили', 'Не получено название ингредиента'
    ...
    @pytest.mark.parametrize(
        ...
        [
            [ingredient_types.INGREDIENT_TYPE_SAUCE, 'Чили', 3000, 'SAUCE'],
